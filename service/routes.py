...
def list_accounts():
    """Lists all Accounts and returns them as a JSON list."""
...
def read_account(account_id):
    """Reads an Account and returns it as a JSON object."""
...
def update_account(account_id):
    """Updates an Account and returns the updated account as JSON."""
